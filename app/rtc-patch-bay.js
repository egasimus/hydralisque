...
const PatchBay = module.exports = function (options) {
// connect to websocket signalling server. To DO: error validation
  this.signaller = require('socket.io-client')(options.server)

  //assign unique id to this peer, or use id passed in

  this.id = options.id || require('shortid').generate()
...
require('inherits')(PatchBay, require('events').EventEmitter)
...
PatchBay.prototype.initRtcPeer = function(id, opts) {
  ...
  var options = Object.assign(this._peerOptions, newOptions)
console.log("OPTIONS", options)
  this.rtcPeers[id] = new (require('simple-peer'))(options)
